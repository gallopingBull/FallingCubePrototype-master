namespace galloping_bull.infinite_squared.PlayerController
{
    ...
    private string R_TriggerName = "RT_Linux";
        ...
        protected override void ClimbHandle()
        {
            base.ClimbHandle();
        }

        protected override void ClimbJumpHandle()
        {
            base.ClimbJumpHandle();
        }

        protected override void ClimbUpHandle()
        {
            base.ClimbUpHandle();
        }
